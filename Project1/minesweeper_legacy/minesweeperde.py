...
class MinesweeperAI():
    ...
    def update_knowledge(self):
        for i, sentence0 in enumerate(self.knowledge):
            for j, sentence1 in enumerate(self.knowledge):
                if i != j and sentence0 == sentence1:
                    self.knowledge.remove(sentence0)
                elif i != j and sentence1.cells.issubset(sentence0.cells):
